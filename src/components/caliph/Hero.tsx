  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute top-1/2 -right-10 w-80 h-80 bg-gold/5 rounded-full blur-3xl animate-float"
      ...
      <div className="container mx-auto px-6 h-full flex flex-col justify-center relative z-10">
        <Link
          to="/#caliphs"
          className="flex items-center text-gold hover:text-gold-light mb-6 transition-colors w-fit"
        >
        ...
        <div className="mb-6 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-arabic text-gold-light mb-2 opacity-80">
            {caliph.arabicName}
          </h2>
        </div>
        ...
        <h1
          ...
          style={{
            ...
            textShadow:
              "0 5px 20px rgba(0,0,0,0.5), 0 0 30px rgba(212,175,55,0.3)",
          }}
        >
          {caliph.name}
        </h1>
        ...
        >
          <span className="text-lg md:text-xl font-cinzel text-gold-light">
            {caliph.title}
          </span>
        ...
        <p
          className="max-w-2xl text-white/80 text-lg animate-fade-in"
